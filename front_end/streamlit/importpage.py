...
def import_page():
    try:
        ...
        st.markdown("<h1 style='font-family: Arial, sans-serif; color: #fb8c00;'>Graph Visualization & File Upload</h1>", unsafe_allow_html=True)
                ...
                if os.path.exists(ann_path):
                    ...
                    if st.session_state.is_main_running:
                        ...
                        with st.spinner("Processing your files and generating ontology. Please wait..."):
                            try:
                                # Run the main function with the toggle value for use_user_owl
                                main(user_ann_name, ann_path, use_user_owl=use_user_owl)
        ...
        st.markdown("<h1 style='font-family: Arial, sans-serif; color: #fb8c00;'>View Uploaded Files</h1>", unsafe_allow_html=True)
